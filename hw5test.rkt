...
(define tests
  (test-suite
   ...
   ;; mupl-map test
   ;; inner (call ...) returns closure with mupl-map function and (fun ...) argument in environment
   ;; outer (call ...) receives closure with list argument added to closure environment
